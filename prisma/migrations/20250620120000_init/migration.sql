...
-- CreateEnum
CREATE TYPE "PaymentProvider" AS ENUM ('RAZORPAY', 'PHONEPE');
...
-- CreateIndex
CREATE UNIQUE INDEX "Order_phonePeMerchantOrderId_key" ON "Order"("phonePeMerchantOrderId");
